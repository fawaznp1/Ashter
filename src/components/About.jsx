    ...
    <section className="about-container">
      ...
      <div className="about-content">
        ...
        <div className="about-text">
          <p>
            Welcome to Ashter, your trusted partner in managing your healthcare needs
            conveniently and efficiently. At Ashter, we understand the challenges
            individuals face when it comes to scheduling doctor appointments and managing
            their health records.
          </p>
          <p>
            Ashter is committed to excellence in healthcare technology. We continuously
            ...
            appointment or managing ongoing care, Ashter is here to support you every step
            of the way.
          </p>
          <h4>Our Vision</h4>
          <p>
            Our vision at Ashter is to create a seamless healthcare experience for every
