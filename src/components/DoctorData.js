...
export  const doctorsData = [
  {
    ...
    appointmentFee: '$150',
    experience: '15 years',
    education: 'MD from Obama Hopkins University',
  ...
  },
  {
    ...
    description: 'Dr. Johuan Chen is a board-certified neurologist who specializes in diagnosing and treating conditions affecting the brain, spinal cord, and nervous system. He has particular expertise in headache disorders, stroke management, and neurodegenerative diseases.',
    languages: ['English', 'Mandarin'],
    rating: 4.8,
    reviews: 105,
  ...
  {
    id: 20,
    name: 'Dr. Christina Eilish',
    specialty: 'General Physician',
    status: 'Available',
    availability: 'Mon-Fri: 9AM-5PM, Sat: 10AM-2PM',
    appointmentFee: '$120',
    experience: '11 years',
    education: 'MBBS  from Obama Hopkins University',
    description: 'Dr. Christina Eilish is a board-certified general physician with over 15 years of experience. He specializes in preventative care and chronic disease management. Dr. Christina takes a holistic approach to healthcare, focusing on both physical and mental wellbeing.',
  ...
  },
  {
    ...
    experience: '11 years',
    education: 'MBBS  from Obama Hopkins University',
    description: 'Dr. Susan Peter is a board-certified general physician with over 15 years of experience. He specializes in preventative care and chronic disease management. Dr. Susan takes a holistic approach to healthcare, focusing on both physical and mental wellbeing.',
